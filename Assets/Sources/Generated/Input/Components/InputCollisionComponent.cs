...
public partial class InputEntity {
    ...
    public void AddCollision(Entitas.IEntity newSelf, Entitas.IEntity newOther) {
    ...
    public void ReplaceCollision(Entitas.IEntity newSelf, Entitas.IEntity newOther) {
        var index = InputComponentsLookup.Collision;
        var component = CreateComponent<CollisionComponent>(index);
        component.self = newSelf;
        component.other = newOther;
